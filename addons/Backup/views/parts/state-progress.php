<div class="kiss-padding-larger kiss-align-center animated fadeIn" v-if="state.view === 'progress'">
    <div class="kiss-margin">
        ...
        <icon class="kiss-color-danger" size="large" v-else-if="state.finished && state.isError">error</icon>

        <icon class="kiss-color-success" size="large" v-else-if="state.finished && !state.isError">check_circle</icon>
    </div>
